        ...
        items: [
            {
                ...
                "caption": 'Lorem, ipsum dolor sit amet consectetur adipisicing elit. Neque mollitia deleniti cum similique unde atque sapiente! Lorem, ipsum dolor sit amet consectetur adipisicing elit. Neque mollitia deleniti cum similique unde atque sapiente! 💖🙌'
            },
            {
...
followingsButton.addEventListener('click', () => {
    modalScreen.classList.contains("visible") ?
        modalScreen.classList.remove("visible") : modalScreen.classList.add("visible")
...
const modalCloseHandler = () => { modalScreen.classList.remove("visible") }
const modalOpenHandler = () => { modalScreen.classList.add("visible") }
...
const tabsFunc = () => {
    ...
    tabs.forEach(element => {
        buttonsContainer.insertAdjacentHTML('beforeend', `<button onclick="changePage('${element.title}')" class='profile-feed__button ${currentTab === element.title ? "isActive" : ""}'>
        ${element.title}
    </button>`)
        ...
        if (currentTab === element.title) {
            if (element.items.length && element.title === "Posts") {
                ...
                element.items.forEach(item => {
                    ...
                    feedsContainer.insertAdjacentHTML('beforeend', `
        ...
        `
            ...
            if (element.items.length && element.title === "Reels") {
                element.items.forEach(item => {
                    // نمایش محتوای هر آیتم
                    feedsContainer.className = 'flex items-center reels_container flex-wrap gap-3 mt-5'
                    feedsContainer.insertAdjacentHTML('beforeend', `
                    <article class="reel">
